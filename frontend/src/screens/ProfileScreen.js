...
const ProfileScreen = () => {
    ...
    //userInfo is a JSON with the details of the user currently logged-in
  ...
  return (
    <Row>
        ...
        <Col md={9}>
            <h2>My Orders</h2>
            {
                loadingOrders ? <LoaderComp/> : errorOrders ? <MessageComp variant='danger'>{errorOrders}</MessageComp> :
                (
